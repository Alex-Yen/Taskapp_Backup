...
public class Contractor extends AppCompatActivity {
    ...
    User_Adapter UA;
    String url = "http://192.168.0.105/taskapp00/User_joblist.php", name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_contractor_landlord);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Contractor Homepage");
        ...
        _user_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, final int position, long Username) {
                startActivity(new Intent(getApplicationContext(), job_detail_contractor.class).putExtra("position", position));
            }
        });
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.contractor_bot_navigator);

        //Set Home Select
        bottomNavigationView.setSelectedItemId(R.id.user2_nav_home);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.user2_nav_home:
                        return true;
                    case R.id.user2_nav_logout:
